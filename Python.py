...
tobecontinued = pygame.image.load("C:/Users/mhkan/Documents/jh/To Be Continued.jpg").convert
...
class Python(object):
    ...
    def move(self):
        ...
        if new in self.positions[2:]:
            self.create()
            pygame.mixer_music.load('C:/Users/mhkan/Documents/PythonProjects/numpy/pygame_basic/explosion.mp3')
            pygame.mixer_music.play()
            pygame.mixer_music.load('C:/Users/mhkan/Documents/jh/To Be Continued [Sound Effect] [Perfect Cut].mp3')
            pygame.mixer_music.play()
            time.sleep(10)
            pygame.quit()
            sys.exit
...
def show_info(length, speed, surface):
    ...
    text = font.render("Score: " + str(length) + "       Speed : " + str(round(speed, 2)), 1, GRAY)
    pos = text.get_rect()
    pos.centerx = 150
